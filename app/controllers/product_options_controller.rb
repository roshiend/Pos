class ProductOptionsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @product_option.save
        format.html { redirect_to product_option_url(@product_option), notice: "Product option was successfully created." }
  ...
  def update
    respond_to do |format|
      if @product_option.update(product_option_params)
        format.html { redirect_to product_option_url(@product_option), notice: "Product option was successfully updated." }
  ...
  private
    ...
    def product_option_params
      params.require(:product_option).permit(:product_option_name, :product_option_values)
    end
end
