class ProductsController < ApplicationController
  ...
  private
    ...
    def product_params
      params.require(:product).permit(:name,:description,:master_price,variants_attributes: [:id,:option1, :option2, :option3, :sku, :price,:unique_id,:position],option_types_attributes:[:id,:name,:position,:_destroy,option_values_attributes: [:id,:position,:_destroy,name:[]]])
    end
