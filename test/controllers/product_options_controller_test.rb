...
class ProductOptionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create product_option" do
    assert_difference("ProductOption.count") do
      post product_options_url, params: { product_option: { product_option_name: @product_option.product_option_name, product_option_values: @product_option.product_option_values } }
    end
  ...
  test "should update product_option" do
    patch product_option_url(@product_option), params: { product_option: { product_option_name: @product_option.product_option_name, product_option_values: @product_option.product_option_values } }
